...
if($config['site']['shop_system'])
{
	...
	if(($action == '') or ($action == 'item') or ($action == 'mount') or ($action == 'addon') or ($action == 'container') or ($action == 'mage') or ($action == 'pala') or ($action == 'kina') or ($action == 'deco'))
	{
		...
		if((count($offer_list['item']) > 0) or (count($offer_list['mount']) > 0) or (count($offer_list['addon']) > 0) or (count($offer_list['container']) > 0) or (count($offer_list['mage']) > 0) or (count($offer_list['pala']) > 0) or (count($offer_list['kina']) > 0) or (count($offer_list['deco']) > 0))
		{
			$main_content .= '<center><TABLE WIDTH=100% BORDER=0 CELLSPACING=0 CELLPADDING=4><TR>';
			if(count($offer_list['item']) > 0) $main_content .= '<center><a href="?subtopic=shopsystem&action=item" style="padding: 5px 5px 7px 5px; margin: 5px 1px 0px 1px; background-color: '.selectcolor('item').';">Items<img src="/images/items/2160.gif"></a>';
			if(count($offer_list['mount']) > 0) $main_content .= '<a href="?subtopic=shopsystem&action=mount" style="padding: 5px 5px 7px 5px; margin: 5px 1px 0px 1px; background-color: '.selectcolor('mount').';">Mounts<img src="/images/items/92.gif"></a>';
			if(count($offer_list['addon']) > 0) $main_content .= '<a href="?subtopic=shopsystem&action=addon" style="padding: 5px 5px 7px 5px; margin: 5px 1px 0px 1px; background-color: '.selectcolor('addon').';">Addons<img src="/images/items/128.gif"></a>';
			if(count($offer_list['mage']) > 0) $main_content .= '<a href="?subtopic=shopsystem&action=mage" style="padding: 5px 5px 7px 5px; margin: 5px 1px 0px 1px; background-color: '.selectcolor('mage').';">Mage<img src="/images/items/18390.gif"></a>';
			if(count($offer_list['pala']) > 0) $main_content .= '<a href="?subtopic=shopsystem&action=pala" style="padding: 5px 5px 7px 5px; margin: 5px 1px 0px 1px; background-color: '.selectcolor('pala').';">Pala<img src="/images/items/22421.gif"></a>';
			if(count($offer_list['kina']) > 0) $main_content .= '<a href="?subtopic=shopsystem&action=kina" style="padding: 5px 5px 7px 5px; margin: 5px 1px 0px 1px; background-color: '.selectcolor('kina').';">Kina<img src="/images/items/22409.gif"></a>';			
			if(count($offer_list['container']) > 0) $main_content .= '<a href="?subtopic=shopsystem&action=container" style="padding: 5px 5px 7px 5px; margin: 5px 1px 0px 1px; background-color: '.selectcolor('container').';">Container</a></center>';
		...
		if((count($offer_list['mage']) > 0) and ($action == 'mage'))
		{
			...
			foreach($offer_list['mage'] as $mage)
			{
				...
				{
					$main_content .= '<form action="?subtopic=shopsystem&action=select_player" method="POST" name="itemform_'.$mage['id'].'"><input type="hidden" name="buy_id" value="'.$mage['id'].'"><div class="navibutton"><a href="" onClick="itemform_'.$mage['id'].'.submit();return false;">BUY</a></div></form>';
				}
				$main_content .= '</td></tr>';
			}
			$main_content .= '</table>';
		...
		if((count($offer_list['pala']) > 0) and ($action == 'pala'))
		{
			...
			foreach($offer_list['pala'] as $pala)
			{
				...
				{
					$main_content .= '<form action="?subtopic=shopsystem&action=select_player" method="POST" name="itemform_'.$pala['id'].'"><input type="hidden" name="buy_id" value="'.$pala['id'].'"><div class="navibutton"><a href="" onClick="itemform_'.$pala['id'].'.submit();return false;">BUY</a></div></form>';
				}
				$main_content .= '</td></tr>';
			}
			$main_content .= '</table>';
		...
		if((count($offer_list['kina']) > 0) and ($action == 'kina'))
		{
			...
			foreach($offer_list['kina'] as $kina)
			{
				...
				{
					$main_content .= '<form action="?subtopic=shopsystem&action=select_player" method="POST" name="itemform_'.$kina['id'].'"><input type="hidden" name="buy_id" value="'.$kina['id'].'"><div class="navibutton"><a href="" onClick="itemform_'.$kina['id'].'.submit();return false;">BUY</a></div></form>';
				}
				$main_content .= '</td></tr>';
			}
			$main_content .= '</table>';			
		...
		if((count($offer_list['deco']) > 0) and ($action == 'deco'))
		{
			...
			foreach($offer_list['deco'] as $deco)
			{
				...
				{
					$main_content .= '<form action="?subtopic=shopsystem&action=select_player" method="POST" name="itemform_'.$deco['id'].'"><input type="hidden" name="buy_id" value="'.$deco['id'].'"><div class="navibutton"><a href="" onClick="itemform_'.$deco['id'].'.submit();return false;">BUY</a></div></form>';
				}
				$main_content .= '</td></tr>';
			}
			$main_content .= '</table>';			
