...
if(!defined('INITIALIZED'))
	...
	$main_content .= '<table border="0" cellpadding="4" cellspacing="1" width="95%">
		...
		<tr bgcolor="'.$config['site']['lightborder'].'">
			<td>Frags Time</td><td>4 Horas</td>
		</tr>
		<tr bgcolor="'.$config['site']['darkborder'].'">
			<td>Frags to Red Skull</td><td> 7 Frags</td>
		</tr>
		<tr bgcolor="'.$config['site']['lightborder'].'">
			<td>Frags to Black Skull</td><td> 10 Frags</td>
		</tr>
	</table><br>';
	$main_content .= '<table border="0" cellpadding="4" cellspacing="1" width="95%">
		<tr bgcolor="'.$config['site']['vdarkborder'].'">
		...
		<tr bgcolor="'.$config['site']['darkborder'].'">
			<td>Level to buy house</td><td>150</td>
		</tr>
		<tr bgcolor="'.$config['site']['lightborder'].'">
			<td>Level to create guild</td><td>150</td>
		</tr>
		<!--
		<tr bgcolor="'.$config['site']['darkborder'].'">
			<td></td><td></td>
