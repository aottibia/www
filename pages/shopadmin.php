<img id="ContentBoxHeadline" class="Title" src="layouts/tibiacom/images/header/headline-shopadmin.gif" alt="Contentbox headline">
<?PHP
...
<center><a href="?subtopic=shopadmin&action=addoffer">ADD SHOP OFFER</a><br><br><a href="?subtopic=shopadmin&action=points">ADD POINTS</a></center>
</td>
</tr>
</tbody>
</table>
	...
	if($action == "addoffer"){
		...
		if(empty($shop_points)) {
			$main_content .= '<table border="0"><tr><td  align="center"><b>Select offer type:</b></td><td><table border="0" ><tr bgcolor="#505050">
				<td><font color="white"><center><b>Item</b></center></td><td><font color="white"><center><b>Item VIP</b></center></td><td><font color="white"><center><b>Container</b></center></td><td><font color="white"><center><b>Pacc<br /><small style="color:orangered;">[PremDays]</small></b></center></td><td><font color="white"><center><b>VIP Days<br /><small style="color:orangered;">[vip_time]</small></b></center></td><td><font color="white"><center><b>Redskull</b></center></td>
				<td><font color="white"><center><b>Unban</b></center></td><td><font color="white"><center><b>Changename</b></center></td></tr><tr bgcolor="#D4C0A1"><form action="" method="post">
