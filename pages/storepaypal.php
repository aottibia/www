...
else
{
	...
	function listaPlayers()
	{
		...
		$o = '<select name="on1" id="on1"><option value="">-- Selecione --</option>';
...
<input type="hidden" name="business" value="mitsuig@xtibia.com">
<input type="hidden" name="lc" value="US">
<input type="hidden" name="item_name" value="Tibia Coins">
