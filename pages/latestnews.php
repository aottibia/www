...
<div id="LayerPop2" align="center" style="position: absolute; top:-520px; margin:auto; padding:auto; width: 100%; z-index: 5000;"><a href="?subtopic=store" target="_BLANK"><img src="http://i.imgur.com/iuihazN.png" class="imgBorder"></a><BR /><input type="button" name="fechar" value="FECHAR" onclick="document.getElementById('LayerPop').style.display = 'none';document.getElementById('LayerPop2').style.display = 'none'" style="font-family: Verdana; font-weight: bold; font-size:10px;  color: #FFFFFF; background-color: #000000; border: 1px solid #fffff;"></div>
        ...
        <div class="Border_3">
            <div class="BoxContent" style="background-image:url('.$layout_name.'/images/content/scroll.gif);">
                ...
                <div id=\'TeaserText\'>
				 ...
				 <b><font size="5px"><center><b><font style="text-decoration: inherit; text-shadow:#000 1px -1px 2px, #000 -1px 1px 2px, #000 1px 1px 2px, #000 -1px -1px 2px" size="1px" color="white">| IP: <font color="green">www.tibiawix.com</font> / Port: <font color="green">7171</font> / Client: <font color="green">10.82</font> |</b></font></center><br></b><font size="2px">Seja bem vindo ao <b><font color="green">TibiaWix</font></b>, contamos com o <b>RLMAP</b> mais completo de todos os servidores atualmente, principais quests <b>SEM MISSOES</b>, Cooldown e Magias reformuladas para um PvP mais dinamico e divertido. <b>Exp shared 100%, All Quests</b>. Diversos bugs fixados e sendo arrumados diariamente. Venha conferir o melhor servidor de todos os tempos! Aqui sua diversao e garantida.<br><center><b><a href="http://www.mediafire.com/download/2vgvbjyc1gjc211/TibiaWix.rar">Download Client</a> | <a href="?subtopic=createaccount">Criar Conta</a></center></b>	
                </font> </div>
	 </div>
            </div>
        </div>
